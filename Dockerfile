...
RUN git clone --recursive https://github.com/digi-serve/ab_service_appbuilder.git app && cd app && git checkout develop && git submodule update --recursive && npm install
